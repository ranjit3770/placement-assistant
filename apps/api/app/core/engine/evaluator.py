...
def evaluate_rule(rule: dict[str, Any], snapshot: dict[str, Any]) -> dict[str, Any]:
    ...
    """
    field_path = rule.get("field") or rule.get("code") # Handle both policy and criterion naming conventions
...
def evaluate_snapshot(snapshot: dict[str, Any], policy_rules: list[dict[str, Any]], requirement_criteria: list[dict[str, Any]]) -> tuple[str, list[dict[str, Any]]]:
    """
