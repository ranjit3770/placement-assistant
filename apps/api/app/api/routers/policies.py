...
from app.api.schemas.policy import (
    DocumentCreate, DocumentResponse, PolicyCreate, PolicyResponse,
    PolicyVersionCreate, PolicyVersionResponse, PolicyRuleCreate, PolicyRuleResponse,
    PolicyTransitionRequest, PolicyActivationRequest, PolicyActivationResponse
)
...
def get_policy_service(request: Request, principal: Principal = Depends(current_principal)) -> PolicyService:
...
@router.post("/versions/{version_id}/processing", response_model=PolicyVersionResponse, status_code=200)
...
@router.post("/versions/{version_id}/approve", response_model=PolicyVersionResponse, status_code=200)
...
@router.post("/versions/{version_id}/activate", response_model=PolicyActivationResponse, status_code=201)
...
@router.post("/versions/{version_id}/archive", response_model=PolicyVersionResponse, status_code=200)
